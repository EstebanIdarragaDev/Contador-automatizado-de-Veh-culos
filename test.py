...
while True:
    ...
    # Area a analizar
    area_pts = np.array([[320, 10], [frame.shape[1]-90, 10], [frame.shape[1]-90, 360], [320, 360]])
    ...
    for cnt in cnts:
        ...
        # en 1 el contador de autos
            if 440 < (x + w) < 460:
                ...
                cv2.line(frame, (430, 10), (430, 360), (0, 255, 0), 3)
                    
                  
    # Visualización del conteo de autos
    cv2.drawContours(frame, [area_pts], -1, (255, 0, 255), 2)
    cv2.line(frame, (430, 10), (430, 360), (0, 255, 255), 1)
